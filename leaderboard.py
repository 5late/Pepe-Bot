...
async def leaderBoard(ctx, arg):
    ...
    if Match['teams'][team.lower(
    )]['has_won'] and not Match['teams'][enemyTeam]['has_won']:
    ...
    if not Match['teams'][team.lower(
    )]['has_won'] and Match['teams'][enemyTeam]['has_won']:
        enemyColor = 0x34ebb4
    elif not Match['teams'][team.lower()]['has_won'] and not Match['teams'][enemyTeam]['has_won']:
        enemyColor = 0xd7d9db
    else:
