...
async def checkapi(ctx):
    ...
    account_response = requests.get(
        'https://api.henrikdev.xyz/valorant/account/Raj/1337')
    ...
    match_response = requests.get(
        'https://api.henrikdev.xyz/valorant/v3/by-puuid/matches/na/01066651-f9b0-55c0-8d3d-674c65351821')
    ...
    mmr_response = requests.get(
        'https://api.henrikdev.xyz/valorant/v2/mmr/na/raj/1337')
    ...
    embed = discord.Embed(
        ...
        description='Tested mmr, match and account endpoints.')
